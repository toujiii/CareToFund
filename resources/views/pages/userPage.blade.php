...
@section('userContent')
<div x-data="{ open: true, activeTab: 'signin' }" class="w-full h-screen  flex justify-center items-center">
    <div :class="open ? 'block' : 'hidden'" class="sideContent relative w-110 h-screen shadow-md p-8 flex flex-col  justify-center">
        <div class="flex flex-col items-center justify-center gap-8">
            ...
            <div x-show="activeTab === 'signin'" class="w-full flex flex-col items-center ">
            ...
            <div x-show="activeTab === 'register'" class="w-full flex flex-col items-center ">
                <div class="flex flex-col ">
        ...
        <p class="text-sm text-center mt-auto">
            © 2025 CareToFund. All rights reserved.
        </p>
    </div>
    <div class="flex flex-1 h-screen flex items-center relative ">
        <button @click="open = !open" class="absolute z-10 bg-white rounded-tr-2xl rounded-br-2xl  text-black w-4 h-18 flex items-center justify-center cursor-pointer hover:bg-gray-300  ">
            <p :class="open ? '' : 'rotate-180'">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-left-fill" viewBox="0 0 16 16">
                    <path d="m3.86 8.753 5.482 4.796c.646.566 1.658.106 1.658-.753V3.204a1 1 0 0 0-1.659-.753l-5.48 4.796a1 1 0 0 0 0 1.506z" />
                </svg>
            </p>
        </button>
        <div class="z-0 w-full h-full flex items-center justify-center">
            More User Page Content
        </div>
    </div>
</div>
@endsection