<div
    ...
    <div
        ...
        <div x-data="{ isAnonymous: false }" class="flex flex-col gap-2 h-fit mt-8">
            ...
            <div class="flex items-start gap-2 mt-2">
                ...
                <label for="termsCheckbox" class="text-xs text-gray-300 ">
            ...
            <button class="btn-pink mt-4  self-end text-sm">
                Donate Now
            </button>
        </div>
    </div>
