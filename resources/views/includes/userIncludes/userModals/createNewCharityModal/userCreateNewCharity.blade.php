<div
    ...
    >
    <div class="bg-black/60 z-40 backdrop-blur-xs w-full h-full absolute" x-on:click="isCreateNewCharityModalOpen = false;"></div>
    <div
        ...
        <div class="flex justify-between pb-2 border-b mb-2 gap-4">
            ...
            <button class="hover:text-gray-300 cursor-pointer" aria-label="Close" x-on:click=" isCreateNewCharityModalOpen=false;">
