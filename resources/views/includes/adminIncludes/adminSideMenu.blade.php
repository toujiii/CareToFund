 <div x-show="openSideMenu" class="flex" :class="{ 'absolute z-10 h-screen w-screen': adminMobile }">
     <div
         ...
         <div class="flex flex-col t p-4 gap-2">
             <button x-on:click="adminSectionActive = 'charities'" class="flex items-center gap-2 w-full hover:bg-light px-3 py-2 rounded-lg text-white cursor-pointer" :class="{ 'bg-light': adminSectionActive === 'charities' }">
             ...
             <button x-on:click="adminSectionActive = 'requests'"  class="flex items-center gap-2 w-full hover:bg-light px-3 py-2 rounded-lg text-white cursor-pointer" :class="{ 'bg-light': adminSectionActive === 'requests' }">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
                     <path d="M16 8c0 3.866-3.582 7-8 7a9 9 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7M5 8a1 1 0 1 0-2 0 1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
                 </svg>
                 Requests
             </button>
             <button x-on:click="adminSectionActive = 'users'"  class="flex items-center gap-2 hover:bg-light px-3 py-2 rounded-lg text-white cursor-pointer" :class="{ 'bg-light': adminSectionActive === 'users' }">
