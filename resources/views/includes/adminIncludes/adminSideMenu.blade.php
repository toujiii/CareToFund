 <div x-show="openSideMenu" class="flex" :class="{ 'absolute z-10 h-screen w-screen': adminMobile }">
     <div
         class="bg-light-dark w-60 border-r border-gray-700 flex flex-col">
         <div class="w-full p-4  flex flex-col items-center justify-center border-b border-gray-700 ">
         ...
         <div class=" mt-auto px-4 py-8 border-t border-gray-700 w-full ">
     ...
     <div class="bg-black/50 backdrop-blur-xs flex-1 ">
     </div>
