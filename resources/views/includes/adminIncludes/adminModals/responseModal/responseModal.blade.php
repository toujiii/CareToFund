<div
    ...
    role="dialog"
    tabindex="-1"
    x-show="responseModal"
    x-transition.enter.opacity.duration.200ms
    >
    <div class="bg-black/60 z-40 backdrop-blur-xs w-full h-full absolute" x-on:click="responseModal = false;"></div>
    <div
        ...
        <div class="flex justify-end mt-4">
            <button class="bg-light hover:bg-light cursor-pointer rounded-md text-sm w-24 py-2" x-on:click="responseModal = false;">
                Close
            </button>
        </div>
    </div>
