<div
    ...
    role="dialog"
    tabindex="-1"
    x-show="isViewDonationsModalOpen"
    x-transition.enter.opacity.duration.200ms
    >
    <div class="bg-black/60 z-40 backdrop-blur-xs w-full h-full absolute" x-on:click="isViewDonationsModalOpen = false;"></div>
    <div
        ...
        <div class="flex justify-between pb-2 border-b mb-2 gap-4">
            ...
            <button class="hover:text-gray-300 cursor-pointer" aria-label="Close" x-on:click="isViewDonationsModalOpen=false">
        ...
        <p class="text-sm text-gray-300">
            Here is a record of this donations. You can review the details of each donation below.
        </p>
                ...
                <tbody>
                    @for($i = 0; $i < 20; $i++)
                        <tr class="border-b border-white hover:bg-light">
                            <td class="p-2 text-sm">Anonymous {{ $i }}</td>
                            <td class="p-2 text-sm">June 15, 2024</td>
                            <td class="p-2 text-sm text-green-300">PHP 1,000.00</td>
                        </tr>
                    @endfor
                </tbody>
            </table>
