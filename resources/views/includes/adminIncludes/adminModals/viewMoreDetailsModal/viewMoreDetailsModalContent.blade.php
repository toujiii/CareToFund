...
<div
    class="relative z-100 bg-light-dark rounded-lg flex flex-col max-w-3xl shadow-lg m-2 overflow-auto p-4 h-fit max-h-[92vh]"
    ...
    <div class="flex justify-between pb-2 border-b mb-2 gap-4">
        <p class=" text-2xl font-bold">{{ explode(' ', ucfirst($focusedCharityRequest->user->name))[0] }}'s Charity</p>
