<div
    ...
    role="dialog"
    tabindex="-1"
    x-show="isRejectRequestModalOpen"
    ...
    <div
        ...
        <div class="flex justify-between pb-2 border-b mb-2 gap-4">
            <p class=" text-2xl font-bold"> Reject Charity</p>
            <button class="hover:text-gray-300 cursor-pointer" aria-label="Close" x-on:click="isRejectRequestModalOpen=false">
        ...
        <div class="flex justify-end mt-4">
            <button class="bg-light hover:bg-light cursor-pointer rounded-md text-sm w-24" x-on:click="isRejectRequestModalOpen = false; ">
                Cancel
            </button>
            <button class="btn-pink text-sm w-24 ml-2" x-on:click=" isRejectRequestModalOpen = false; ">
                Confirm
            </button>
        </div>
    </div>
